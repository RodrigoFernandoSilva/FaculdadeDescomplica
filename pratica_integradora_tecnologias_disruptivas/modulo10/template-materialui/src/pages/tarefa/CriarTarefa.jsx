        ...
        <CardContent sx={{
          ...
          <Grid item xs={12}>  
            <FormControl fullWidth>
              ...
              <FormHelperText id="tarefa_descricao_helper_text">Taks Description.</FormHelperText>
            </FormControl>
          </Grid>
          <Grid container spacing={2} mt={1}>
            ...
            <Grid item xs={3}>  
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value={'Recurso 1'}>Resource 1</MenuItem>
                  <MenuItem value={'Recurso 2'}>Resource 2</MenuItem>
                  <MenuItem value={'Recurso 3'}>Resource 3</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid item xs={3}>  
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value={'Aguardando'}>To Do</MenuItem>
                  <MenuItem value={'Em Andamento'}>Doing</MenuItem>
                  <MenuItem value={'Concluída'}>Done</MenuItem>
                </Select>
              </FormControl>
            </Grid>
